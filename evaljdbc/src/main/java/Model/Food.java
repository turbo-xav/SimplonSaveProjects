...
public class Food {
	...
	/**
	  * Unité de référence de mesure des masses
	  * 
	  * @access private final static
	  * @name weightUnit
	  * @var String
	...
	/**
	  * Poids de référence des alimenyts dans les indication energétique
	  * 
	  * @access private final static
	  * @name weightUnit
	  * @var String
	...
	/**
	  * id de la catégorie de l'aliment
	  *
	  * @access private
	  * @name categoryId 
	  * @var int 
	...
	/**
	  ...
	  * @return boolean : indique si l'aliment a été trouvé
	  * 
	  */
	...
	/**
	 * Tente de mettre à jour l'aliment
	 * 
	 * @access public
	 * @name update
	 * @return boolean : indique si tout s'est bien déroulé
